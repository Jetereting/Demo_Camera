...
public class ImageSizeDialog extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		final View layout = inflater.inflate(R.layout.ricoh_dialog_image_size,
				null);
		if (null != layout) {
	...
	/**
	 * 当一个对话框被退出时，事件监听接口 Event listener interface for when a dialog is exited If
	 * a selection value is required in this dialog, it is necessary to attach
	 * the activity that implemented this method
	 */

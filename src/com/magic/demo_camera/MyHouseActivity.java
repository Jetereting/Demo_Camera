...
public class MyHouseActivity extends Activity implements OnClickListener {
	...
	private void initView() {
		...
		tev_title_content.setText("我的房产");
	...
	public void onClick(View arg0) {
		...
		case R.id.btn_mytour_waitupload:
			startActivity(new Intent(MyHouseActivity.this,
					UploadMainActivity.class));
			break;
		case R.id.btn_mytour_lookshare:
			Intent intent=new Intent(MyHouseActivity.this,LookShareActivity.class);
			intent.putExtra("type","MyHouseActivity");

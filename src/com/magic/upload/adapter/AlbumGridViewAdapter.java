package com.magic.upload.adapter;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(
					Res.getLayoutID("imgupload_plugin_camera_select_imageview"), parent, false);
		...
		if (path.contains("camera_default")) {
			viewHolder.imageView.setImageResource(Res.getDrawableID("imgupload_plugin_camera_no_pictures"));
		} else {

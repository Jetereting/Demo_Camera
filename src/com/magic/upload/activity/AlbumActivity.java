...
import com.magic.upload.adapter.AlbumGridViewAdapter;
...
public class AlbumActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(Res.getLayoutID("imgupload_plugin_camera_album"));
		PublicWay.activityList.add(this);
		mContext = this;
		IntentFilter filter = new IntentFilter("data.broadcast.action");
		registerReceiver(broadcastReceiver, filter);
		bitmap = BitmapFactory.decodeResource(getResources(),
				Res.getDrawableID("imgupload_plugin_camera_no_pictures"));
		init();
		initListener();
		isShowOkBt();
	}
	...
	private class AlbumSendListener implements OnClickListener {
		public void onClick(View v) {
			overridePendingTransition(R.anim.imgupload_activity_translate_in,
